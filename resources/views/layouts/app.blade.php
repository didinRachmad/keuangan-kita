...
<head>
    ...
    {{-- CSS --}}
    <link href="{{ asset('css/style.css?v=' . date('d')) }}" rel="stylesheet" />
    <link href="{{ asset('css/stylePrint.css?v=' . date('d')) }}" rel="stylesheet" />
    ...
    <script>
        if (localStorage.getItem("darkMode") === "enabled") {
            ...
            .card { background-color: rgba(2, 16, 32, 0.7); }
...
<body class="dark">
    ...
    <div class="main-sidebar">
        <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
                <a href="{{ url('dashboard') }}" class="text-primary fw-bold shadow-light shadow-sm"
                    style="font-size: 16px;"><i class="fas fa-book-open"></i> Keuangan Kita</a>
                @if (strlen(Auth::user()->keluarga?->nama_keluarga) > 25)
                    <p class="text-primary fw-bold"><span class="badge badge-primary"> <i class="fas fa-home"></i>
                            {{ substr(Auth::user()->keluarga?->nama_keluarga, 0, 23) . '..' }}</span></p>
                @else
                    <p class="text-primary fw-bold"><span class="badge badge-primary"> <i class="fas fa-home"></i>
                            {{ Auth::user()->keluarga?->nama_keluarga }}</span></p>
                @endif
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger shadow-danger" href="{{ url('auth/logout') }}">Keluar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- <nav id="sidebar">
        ...
        <ul class="navbar-nav mt-3">
            ...
            @else
                <li class="nav-item">
                    <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Logout"
                        href="{{ route('logout') }}"><i class="bi bi-box-arrow-in-left"></i></a>
                </li>
            @endguest
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Kode Customer"
                    href="{{ route('KodeCustomer.index') }}"><i class="bi bi-qr-code"></i></a>
            </li>
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Tool Outlet"
                    href="{{ route('ToolOutlet.index') }}"><i class="bi bi-gear-fill"></i></a>
            </li>
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="List Rute"
                    href="{{ route('ListRute.index') }}"><i class="bi bi-signpost-split-fill"></i></a>
            </li>
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Tool Depo"
                    href="{{ route('ToolDepo.index') }}"><i class="bi bi-house-gear-fill"></i></a>
            </li>
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Tool Excel"
                    href="{{ route('ToolExcel.index') }}"><i class="bi bi-file-earmark-arrow-up"></i></a>
            </li>
            <li class="nav-item py-3">
                <a class="btn btn-block bg-btn p-2 btn-dark fw-bold" data-tooltip="Exec Rekap"
